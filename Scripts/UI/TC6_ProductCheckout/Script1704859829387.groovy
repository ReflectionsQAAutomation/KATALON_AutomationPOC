...
/**
 * Test Case: User checkout
 * Description: This testcase covers flow of user clicking on the cart page and puchasing the products using different payment methods.
 *
 */
